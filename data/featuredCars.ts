...
export const featuredCars: FeaturedCar[] = [
  {
    ...
    image: "/cars/1/luxury-mercedes-benz-c-class-amg-black.jpg",
    featured: true,
    images: [
      "/cars/1/luxury-mercedes-benz-c-class-amg-black.jpg",
      "/cars/1/mercedes-c-class-interior.png",
      "/cars/1/mercedes-c-class-dashboard.jpg",
      "/cars/1/mercedes-c-class-rear-view.jpg",
      "/cars/1/mercedes-c-class-side-profile.jpg",
    ],
    description: {
  ...
  },
  {
    ...
    fuel: "Diesel",
    transmission: "Automática",
    image: "/cars/2/luxury-bmw-x5-m-sport-grey.jpg",
    featured: true,
    images: [
      "/cars/2/luxury-bmw-x5-m-sport-grey.jpg",
      "/cars/2/bmw-x5-interior-luxury.jpg",
      "/cars/2/bmw-x5-dashboard-technology.jpg",
      "/cars/2/bmw-x5-rear-seats.jpg",
      "/cars/2/bmw-x5-m-sport-wheels.jpg",
    ],
    description: {
  ...
  },
  {
    ...
    fuel: "Diesel",
    transmission: "Automática",
    image: "/cars/3/luxury-audi-a6-avant-s-line-white.jpg",
    featured: true,
    images: [
      "/cars/3/luxury-audi-a6-avant-s-line-white.jpg",
      "/cars/3/audi-a6-avant-interior.jpg",
      "/cars/3/audi-a6-avant-virtual-cockpit.jpg",
      "/cars/3/audi-a6-avant-cargo-space.jpg",
      "/cars/3/audi-a6-avant-s-line-wheels.jpg",
    ],
    description: {
